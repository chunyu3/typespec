...
import { getPopupAction } from "./extension-log-listener.js";
...
export class TerminalLogListener implements LogListener {
  ...
  Log(log: LogItem) {
    ...
    switch (log.level) {
      case "error":
        this.terminal?.sendText(log.message, false);
